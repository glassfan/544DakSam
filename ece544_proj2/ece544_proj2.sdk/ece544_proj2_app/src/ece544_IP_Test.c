...
int main()
{
	...
	// XGpio_DiscreteWrite(&GPIOInst0, GPIO_0_OUTPUT_0_CHANNEL, 0xFF);
	// int temp = 1;
	u8 motor_speed = 0x00;
	u8 motor_direction = 0x00;
	...
	while (1)
	{
		...
		//else{
			// XGpio_DiscreteWrite(&GPIOInst0, GPIO_0_OUTPUT_0_CHANNEL, 0x00);
		//}
		if (NX4IO_isPressed(BTND)){
			motor_speed -= 10;
		}

		XGpio_DiscreteWrite(&GPIOInst0, GPIO_0_OUTPUT_0_CHANNEL, motor_speed);
//		if ((timestamp % 1000000) == 0){
//			if (temp){
//				XGpio_DiscreteWrite(&GPIOInst0, GPIO_0_OUTPUT_0_CHANNEL, 0x2);
//				temp = 0;
//			} else {
//				XGpio_DiscreteWrite(&GPIOInst0, GPIO_0_OUTPUT_0_CHANNEL, 0x0);
//				temp = 1;
//			}
//		}
