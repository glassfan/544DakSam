...
wire	[31:0]	    gpio_in_1;				// embsys GPIO input port
wire	[31:0]	    gpio_out_1;				// embsys GPIO output port
...
// Assign gpio_out to JB PMOD output
// assign JB[7:0] = gpio_out[7:0];
...
MOTOR_SPEED_DETECTOR motor_speed_detector(
    .clk(clk_10MHz),
    .reset_n(sysreset_n),
    .motor_sensor_input_a(JB[2]),
    .motor_sensor_input_b(JB[3]),
...
embsys EMBSYS
       (// PMOD OLED pins 
        ...
        .GPIO3_tri_i(gpio_in_1),
        .GPIO4_tri_o(gpio_out_1),
        // Pmod Rotary Encoder
	    .pmodENC_A(rotary_a),
        .pmodENC_B(rotary_b),
